...
function love.load()
    ...
    finalSound = love.audio.newSource('sounds/powerup-reveal.wav', 'static')
...
function displayVictory()
    ...
    love.graphics.printf('THANK YOU FOR PLAYING!', 50, 80, VIRTUAL_WIDTH, 'center')
    love.graphics.printf('This was CS50x!', 50, 150, VIRTUAL_WIDTH, 'center')
end
